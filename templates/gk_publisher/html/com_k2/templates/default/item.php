...
<article id="k2Container" class="itemView<?php echo $k2ContainerClasses; ?>"> <?php echo $this->item->event->BeforeDisplay; ?> <?php echo $this->item->event->K2BeforeDisplay; ?>
	...
	<section>
		...
		<div class="itemBody">
			...
			<div id="gk-what"><h2><a href="http://getfut.ru" title="рыночная экономика">рыночная экономика</a></h2></div>
			...
			<div class="itemInfoBlock">				
				...
				<div id="gk-whats"><h2><a href="http://webecon.ru" title="новости бизнеса сегодня">новости бизнеса сегодня</a></h2></div>
